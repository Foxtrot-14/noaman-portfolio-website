...
function i(n2, r2) {
  ...
  var o2 = function(n3) {
    ...
    "string" == typeof n3 && (n3 = function(n4) {
      ...
      if (r4 = R.hex8.exec(n4)) return { r: q(r4[1]), g: q(r4[2]), b: q(r4[3]), a: T(r4[4]), format: o4 ? "name" : "hex8" };
      if (r4 = R.hex6.exec(n4)) return { r: q(r4[1]), g: q(r4[2]), b: q(r4[3]), format: o4 ? "name" : "hex" };
      if (r4 = R.hex4.exec(n4)) return { r: q(r4[1] + "" + r4[1]), g: q(r4[2] + "" + r4[2]), b: q(r4[3] + "" + r4[3]), a: T(r4[4] + "" + r4[4]), format: o4 ? "name" : "hex8" };
      if (r4 = R.hex3.exec(n4)) return { r: q(r4[1] + "" + r4[1]), g: q(r4[2] + "" + r4[2]), b: q(r4[3] + "" + r4[3]), format: o4 ? "name" : "hex" };
      return false;
    }(n3));
    "object" == a(n3) && (J(n3.r) && J(n3.g) && J(n3.b) ? (d2 = n3.r, p2 = n3.g, b2 = n3.b, r3 = { r: 255 * E(d2, 255), g: 255 * E(p2, 255), b: 255 * E(b2, 255) }, c2 = true, u2 = "%" === String(n3.r).substr(-1) ? "prgb" : "rgb") : J(n3.h) && J(n3.s) && J(n3.v) ? (i2 = A(n3.s), l2 = A(n3.v), r3 = function(n4, r4, o4) {
      n4 = 6 * E(n4, 360), r4 = E(r4, 100), o4 = E(o4, 100);
    ...
    }(n3.h, i2, l2), c2 = true, u2 = "hsv") : J(n3.h) && J(n3.s) && J(n3.l) && (i2 = A(n3.s), s2 = A(n3.l), r3 = function(n4, r4, o4) {
      var a2, e2, t2;
      function i3(n5, r5, o5) {
        return o5 < 0 && (o5 += 1), o5 > 1 && (o5 -= 1), o5 < 1 / 6 ? n5 + 6 * (r5 - n5) * o5 : o5 < 0.5 ? r5 : o5 < 2 / 3 ? n5 + (r5 - n5) * (2 / 3 - o5) * 6 : n5;
      }
      if (n4 = E(n4, 360), r4 = E(r4, 100), o4 = E(o4, 100), 0 === r4) a2 = e2 = t2 = o4;
      else {
    ...
    var d2, p2, b2;
    return o3 = z(o3), { ok: c2, format: n3.format || u2, r: Math.min(255, Math.max(r3.r, 0)), g: Math.min(255, Math.max(r3.g, 0)), b: Math.min(255, Math.max(r3.b, 0)), a: o3 };
  }(n2);
...
function l(n2, r2, o2) {
  n2 = E(n2, 255), r2 = E(r2, 255), o2 = E(o2, 255);
...
function c(n2, r2, o2, a2) {
  var e2 = [N(Math.round(n2).toString(16)), N(Math.round(r2).toString(16)), N(Math.round(o2).toString(16))];
...
function u(n2, r2, o2, a2) {
  return [N(_(a2)), N(Math.round(n2).toString(16)), N(Math.round(r2).toString(16)), N(Math.round(o2).toString(16))].join("");
}
function d(n2, r2) {
  r2 = 0 === r2 ? 0 : r2 || 10;
  var o2 = i(n2).toHsl();
  return o2.s -= r2 / 100, o2.s = S(o2.s), i(o2);
}
function p(n2, r2) {
  r2 = 0 === r2 ? 0 : r2 || 10;
  var o2 = i(n2).toHsl();
...
function h(n2, r2) {
  r2 = 0 === r2 ? 0 : r2 || 10;
  var o2 = i(n2).toHsl();
  return o2.l += r2 / 100, o2.l = S(o2.l), i(o2);
}
function m(n2, r2) {
  r2 = 0 === r2 ? 0 : r2 || 10;
  var o2 = i(n2).toRgb();
...
i.prototype = { isDark: function() {
  ...
  return this._a = z(n2), this._roundA = Math.round(100 * this._a) / 100, this;
}, toHsv: function() {
  ...
  return function(n3, r2, o2, a2, e2) {
    var t2 = [N(Math.round(n3).toString(16)), N(Math.round(r2).toString(16)), N(Math.round(o2).toString(16)), N(_(a2))];
  ...
  return { r: Math.round(100 * E(this._r, 255)) + "%", g: Math.round(100 * E(this._g, 255)) + "%", b: Math.round(100 * E(this._b, 255)) + "%", a: this._a };
  ...
  if ("object" == a(n2)) {
    var o2 = {};
    for (var e2 in n2) n2.hasOwnProperty(e2) && (o2[e2] = "a" === e2 ? n2[e2] : A(n2[e2]));
    n2 = o2;
  }
  return i(n2, r2);
...
var D;
var M;
var R = (D = "[\\s|\\(]+(" + (C = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + C + ")[,|\\s]+(" + C + ")\\s*\\)?", M = "[\\s|\\(]+(" + C + ")[,|\\s]+(" + C + ")[,|\\s]+(" + C + ")[,|\\s]+(" + C + ")\\s*\\)?", { CSS_UNIT: new RegExp(C), rgb: new RegExp("rgb" + D), rgba: new RegExp("rgba" + M), hsl: new RegExp("hsl" + D), hsla: new RegExp("hsla" + M), hsv: new RegExp("hsv" + D), hsva: new RegExp("hsva" + M), hex3: /^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, hex6: /^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/, hex4: /^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, hex8: /^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/ });
function J(n2) {
...
var B = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, l2 = e2.fontSize, s2 = null == r2 ? void 0 : r2.easing, c2 = F(null == r2 ? void 0 : r2.speedPlus, "1s").animationPeriod, u2 = function(n2) {
    ...
    if (n2 instanceof Array) {
      for (var o2 = X(n2, Y.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) try {
        if (!(s3 = i(o2[a3])).isValid()) throw new Error("invalid color");
    ...
    try {
      ...
      var s3;
      if (!(s3 = i(n2)).isValid()) throw new Error("Invalid color");
      var c3;
      for (e3 = (c3 = s3.toRgb()).r, t3 = c3.g, l3 = c3.b, a3 = 0; a3 < Y.length; a3++) r3[Y[a3]] = "".concat(e3, ", ").concat(t3, ", ").concat(l3);
    } catch (o3) {
  ...
  return import_react.default.createElement("span", { className: "rli-d-i-b atom-rli-bounding-box", style: o(o(o(o(o({}, l2 && { fontSize: l2 }), c2 && { "--rli-animation-duration": c2 }), s2 && { "--rli-animation-function": s2 }), u2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b atom-indicator" }, import_react.default.createElement("span", { className: "rli-d-i-b electron-orbit" }), import_react.default.createElement("span", { className: "rli-d-i-b electron-orbit" }), import_react.default.createElement("span", { className: "rli-d-i-b electron-orbit" })), import_react.default.createElement(j, { className: "atom-text", staticText: true, text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor }));
};
...
var V = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1.2s").animationPeriod, c2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, Z.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[Z[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var e3 = 0; e3 < Z.length; e3++) r3[Z[e3]] = n2;
    } catch (o3) {
      ...
      for (e3 = 0; e3 < Z.length; e3++) r3[Z[e3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : "");
  return import_react.default.createElement("span", { className: "rli-d-i-b commet-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b commet-indicator" }, import_react.default.createElement("span", { className: "rli-d-i-b commet-box" }, import_react.default.createElement("span", { className: "rli-d-i-b commet-trail trail1" }), import_react.default.createElement("span", { className: "rli-d-i-b  commetball-box" })), import_react.default.createElement("span", { className: "rli-d-i-b commet-box" }, import_react.default.createElement("span", { className: "rli-d-i-b commet-trail trail2" }), import_react.default.createElement("span", { className: "rli-d-i-b commetball-box" })), import_react.default.createElement(j, { className: "commet-text", text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor })));
};
...
var G = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1.5s").animationPeriod, c2 = function(n2) {
    var r3 = {}, o2 = $.length;
    if (n2 instanceof Array) {
      for (var a3 = X(n2, o2), e3 = 0; e3 < a3.length && !(e3 >= 4); e3++) r3[$[e3]] = a3[e3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var t3 = 0; t3 < o2; t3++) r3[$[t3]] = n2;
    } catch (a4) {
...
var K = W("object" == typeof window && window) || W("object" == typeof self && self) || W("object" == typeof global && global) || /* @__PURE__ */ function() {
  return this;
...
var rn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1.2s").animationPeriod, c2 = function(n2) {
    var r3 = {}, o2 = nn.length;
    if (n2 instanceof Array) {
      for (var a3 = X(n2, o2), e3 = 0; e3 < a3.length && !(e3 >= 4); e3++) r3[nn[e3]] = a3[e3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var t3 = 0; t3 < o2; t3++) r3[nn[t3]] = n2;
    } catch (a4) {
  ...
  }), import_react.default.createElement(j, { className: "OP-dotted-text", text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor })));
};
...
var an = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1.2s").animationPeriod, c2 = function(n2) {
    var r3 = {}, o2 = on.length;
    if (n2 instanceof Array) {
      for (var a3 = X(n2, o2), e3 = 0; e3 < a3.length && !(e3 >= 4); e3++) r3[on[e3]] = a3[e3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var t3 = 0; t3 < o2; t3++) r3[on[t3]] = n2;
    } catch (a4) {
  ...
  })), import_react.default.createElement(j, { text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor }));
};
...
var ln = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1.2s").animationPeriod, c2 = function(n2) {
    var r3 = {}, o2 = tn.length;
    if (n2 instanceof Array) {
      for (var a3 = X(n2, o2), e3 = 0; e3 < a3.length && !(e3 >= 4); e3++) r3[tn[e3]] = a3[e3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var t3 = 0; t3 < o2; t3++) r3[tn[t3]] = n2;
    } catch (a4) {
      ...
      for (t3 = 0; t3 < o2; t3++) r3[tn[t3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : ""), u2 = r2.dense ? "0.45em" : "";
  return import_react.default.createElement("span", { className: "rli-d-i-b OP-annulus-dual-sectors-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b OP-annulus-dual-sectors-indicator" }, import_react.default.createElement("span", { className: "rli-d-i-b annulus-sectors", style: o({}, u2 && { borderWidth: u2 }) }), import_react.default.createElement(j, { className: "OP-annulus-dual-sectors-text", text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor })));
};
...
var un = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, l2 = e2.fontSize, s2 = null == r2 ? void 0 : r2.easing, c2 = F(null == r2 ? void 0 : r2.speedPlus, "1s").animationPeriod, u2 = function(n2) {
    var r3 = {}, o2 = sn.length;
    if (n2 instanceof Array) {
      for (var a3 = X(n2, o2), e3 = 0; e3 < a3.length && !(e3 >= 4); e3++) {
        var t3 = sn[e3];
        try {
          if (!(c3 = i(a3[e3])).isValid()) throw new Error("Invalid Color: ".concat(c3.getOriginalInput()));
          var l3 = c3.setAlpha(cn(c3.getAlpha())).toRgbString(), s3 = a3[e3];
          r3[t3[0]] = l3, r3[t3[1]] = s3;
        } catch (n3) {
          s3 = U, l3 = (c3 = i(U)).setAlpha(cn(c3.getAlpha())).toRgbString();
          r3[t3[0]] = l3, r3[t3[1]] = s3;
        }
      }
      return r3;
    ...
    try {
      var c3 = i(n2);
      if ("string" != typeof n2) throw new Error("Color String expected");
      if (!c3.isValid()) throw new Error("Invalid Color: ".concat(c3.getOriginalInput()));
      ...
      for (s3 = U, l3 = (c3 = i(U)).setAlpha(cn(c3.getAlpha())).toRgbString(), u3 = 0; u3 < sn.length; u3++) {
        r3[(t3 = sn[u3])[0]] = l3, r3[t3[1]] = s3;
      }
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : ""), d2 = r2.dense ? "0.45em" : "";
  return import_react.default.createElement("span", { className: "rli-d-i-b OP-annulus-sector-track-rli-bounding-box", style: o(o(o(o(o({}, l2 && { fontSize: l2 }), c2 && { "--rli-animation-duration": c2 }), s2 && { "--rli-animation-function": s2 }), u2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b OP-annulus-sector-track-indicator" }, import_react.default.createElement("span", { className: "rli-d-i-b annulus-track-ring", style: o({}, d2 && { borderWidth: d2 }) }), import_react.default.createElement(j, { className: "OP-annulus-sector-text", text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor })));
};
var dn = function(r2) {
...
var bn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1s").animationPeriod, c2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, pn.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[pn[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var e3 = 0; e3 < pn.length; e3++) r3[pn[e3]] = n2;
    } catch (o3) {
      ...
      for (e3 = 0; e3 < pn.length; e3++) r3[pn[e3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : "");
  return import_react.default.createElement("span", { className: "rli-d-i-b foursquare-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b foursquare-indicator" }, import_react.default.createElement("span", { className: "squares-container" }, import_react.default.createElement("span", { className: "square square1" }), import_react.default.createElement("span", { className: "square square2" }), import_react.default.createElement("span", { className: "square square3" }), import_react.default.createElement("span", { className: "square square4" }))), import_react.default.createElement(j, { text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor, staticText: true }));
};
...
var mn = function(r2) {
  ...
  var u2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, hn.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[hn[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var e3 = 0; e3 < hn.length; e3++) r3[hn[e3]] = n2;
    } catch (o3) {
...
var fn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1s").animationPeriod, c2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, gn.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[gn[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var e3 = 0; e3 < gn.length; e3++) r3[gn[e3]] = n2;
    } catch (o3) {
      ...
      for (e3 = 0; e3 < gn.length; e3++) r3[gn[e3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : "");
  return import_react.default.createElement("span", { className: "rli-d-i-b riple-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b riple-indicator" }, import_react.default.createElement("span", { className: "rli-d-i-b riple" }), import_react.default.createElement("span", { className: "rli-d-i-b riple" }), import_react.default.createElement(j, { className: "riple-text", text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor })));
};
...
var yn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1.2s").animationPeriod, c2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, vn.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[vn[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      ...
      for (e3 = 0; e3 < vn.length; e3++) r3[vn[e3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : "");
  return import_react.default.createElement("span", { className: "rli-d-i-b pulsate-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b pulsate-indicator" }, import_react.default.createElement("span", { className: "rli-d-i-b pulsate-dot" }), import_react.default.createElement("span", { className: "rli-d-i-b pulsate-dot" }), import_react.default.createElement("span", { className: "rli-d-i-b pulsate-dot" })), import_react.default.createElement(j, { staticText: true, text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor }));
};
...
var kn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1s").animationPeriod, c2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, xn.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[xn[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      ...
      for (e3 = 0; e3 < xn.length; e3++) r3[xn[e3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : "");
  return import_react.default.createElement("span", { className: "rli-d-i-b brick-stack-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b brick-stack-indicator" }, import_react.default.createElement("span", { className: "rli-d-i-b brick-stack" })), import_react.default.createElement(j, { staticText: true, text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor }));
};
...
var Pn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1.2s").animationPeriod, c2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, On.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[On[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      ...
      for (e3 = 0; e3 < On.length; e3++) r3[On[e3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : "");
  return import_react.default.createElement("span", { className: "rli-d-i-b bob-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "bob-indicator" }, import_react.default.createElement("span", { className: "bobbing" })), import_react.default.createElement(j, { staticText: true, text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor }));
};
...
var zn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "0.5s").animationPeriod, c2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, wn.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[wn[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      ...
      for (e3 = 0; e3 < wn.length; e3++) r3[wn[e3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : "");
  return import_react.default.createElement("span", { className: "rli-d-i-b bounce-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2) }, import_react.default.createElement("span", { className: "wrapper" }, import_react.default.createElement("span", { className: "group" }, import_react.default.createElement("span", { className: "rli-d-i-b dot" }), import_react.default.createElement("span", { className: "rli-d-i-b dot" }), import_react.default.createElement("span", { className: "rli-d-i-b dot" })), import_react.default.createElement("span", { className: "group" }, import_react.default.createElement("span", { className: "rli-d-i-b shadow" }), import_react.default.createElement("span", { className: "rli-d-i-b shadow" }), import_react.default.createElement("span", { className: "rli-d-i-b shadow" }))), import_react.default.createElement(j, { staticText: true, text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor, style: { marginTop: "2px" } }));
};
var En = function(r2) {
  var a2 = Object(r2).variant, e2 = void 0 === a2 ? "pulsate" : a2;
  return "pulsate" === e2 ? import_react.default.createElement(yn, o({}, r2)) : "brick-stack" === e2 ? import_react.default.createElement(kn, o({}, r2)) : "bob" === e2 ? import_react.default.createElement(Pn, o({}, r2)) : "bounce" === e2 ? import_react.default.createElement(zn, o({}, r2)) : null;
};
...
var qn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "1.2s").animationPeriod, c2 = function(n2) {
    ...
    if (Array.isArray(n2) && n2.length > 0) {
      for (var a3 = X(n2, o2), e3 = 0; e3 < a3.length && !(e3 > o2 - 1); e3++) {
        var t3 = a3[e3];
        r3[Sn[e3]] = t3;
      }
      return r3;
    ...
    try {
      ...
      for (e3 = 0; e3 < o2; e3++) r3[Sn[e3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : "");
  return import_react.default.createElement("span", { className: "rli-d-i-b blink-blur-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b blink-blur-indicator" }, import_react.default.createElement("span", { className: "blink-blur-shape blink-blur-shape1" }), import_react.default.createElement("span", { className: "blink-blur-shape blink-blur-shape2" }), import_react.default.createElement("span", { className: "blink-blur-shape blink-blur-shape3" }), import_react.default.createElement("span", { className: "blink-blur-shape blink-blur-shape4" }), import_react.default.createElement("span", { className: "blink-blur-shape blink-blur-shape5" })), import_react.default.createElement(j, { staticText: true, text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor, style: { marginTop: "0.8em" } }));
};
...
var An = function(r2) {
  ...
  return import_react.default.createElement("span", { className: "rli-d-i-b trophy-spin-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration": s2 }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b trophy-spin-indicator" }, import_react.default.createElement("span", { className: "blade" }), import_react.default.createElement("span", { className: "blade" }), import_react.default.createElement("span", { className: "blade" }), import_react.default.createElement("span", { className: "blade" }), import_react.default.createElement("span", { className: "blade" }), import_react.default.createElement("span", { className: "blade" }), import_react.default.createElement("span", { className: "blade" }), import_react.default.createElement("span", { className: "blade" })), import_react.default.createElement(j, { staticText: true, text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor }));
};
...
var _n = Array.from({ length: 4 }, function(n2, r2) {
...
var Tn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "3s").animationPeriod, c2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, _n.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[_n[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var e3 = 0; e3 < _n.length; e3++) r3[_n[e3]] = n2;
    } catch (o3) {
      ...
      for (e3 = 0; e3 < _n.length; e3++) r3[_n[e3]] = U;
    }
    return r3;
  }(null !== (a2 = null == r2 ? void 0 : r2.color) && void 0 !== a2 ? a2 : "");
  return import_react.default.createElement("span", { className: "rli-d-i-b slab-rli-bounding-box", style: o(o(o(o(o({}, i2 && { fontSize: i2 }), s2 && { "--rli-animation-duration-unitless": parseFloat(s2) }), l2 && { "--rli-animation-function": l2 }), c2), t2), role: "status", "aria-live": "polite", "aria-label": "Loading" }, import_react.default.createElement("span", { className: "rli-d-i-b slab-indicator" }, import_react.default.createElement("span", { className: "slabs-wrapper" }, import_react.default.createElement("span", { className: "slab" }), import_react.default.createElement("span", { className: "slab" }), import_react.default.createElement("span", { className: "slab" }), import_react.default.createElement("span", { className: "slab" }))), import_react.default.createElement(j, { staticText: true, text: null == r2 ? void 0 : r2.text, textColor: null == r2 ? void 0 : r2.textColor }));
};
...
var Cn = Array.from({ length: 4 }, function(n2, r2) {
...
var Dn = function(r2) {
  var a2, e2 = L(null == r2 ? void 0 : r2.style, null == r2 ? void 0 : r2.size), t2 = e2.styles, i2 = e2.fontSize, l2 = null == r2 ? void 0 : r2.easing, s2 = F(null == r2 ? void 0 : r2.speedPlus, "2s").animationPeriod, c2 = function(n2) {
    var r3 = {};
    if (n2 instanceof Array) {
      for (var o2 = X(n2, Cn.length), a3 = 0; a3 < o2.length && !(a3 >= 4); a3++) r3[Cn[a3]] = o2[a3];
      return r3;
    }
    try {
      if ("string" != typeof n2) throw new Error("Color String expected");
      for (var e3 = 0; e3 < Cn.length; e3++) r3[Cn[e3]] = n2;
    } catch (o3) {
